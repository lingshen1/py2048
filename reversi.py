...
def play_victory_song(test_mode=False):
    ...
    # Use ALSA's 'plug:default' rate converter plugin to automatically scale sample rates for Bluetooth devices
    aplay_args = ["aplay", "-D", "plug:default", "-t", "raw", "-r", "8000", "-f", "S16_LE"]
    if not test_mode:
